...
export default function Index({post, allPosts}) {
  console.log(allPosts[0].node.pdf_link)
  return (
        ...
        <Layout>
          <Container>
            <section className="cbu-offer py-4 max-w-3xl mx-auto">
              <h1 className="text-center text-6xl"><b>CLICK BANK UNIVERSITY</b></h1>
              <h2 className="text-center text-4xl">Start making a passive income online <b>today.</b></h2>
              ...
              <div className="video">
                ...
                <div className="buttons flex flex-col grid grid-cols-12 cols-gap-6 md:px-0 md:flex-row justify-center align-center relative block">
                  ...
                  <div className="mx-0 my-2 md:mx-2 col-span-12 md:col-span-6 self-center w-full md:w-auto">
                    <a className="secondary-cta cta py-3 px-4 block md:static text-center" href="cbu/Passion-To-Profits-In-7-Steps.pdf" >DOWNLOAD YOUR FREE BOOK - <b>7 Steps To Turn Your Passion Into An Online Business</b></a>
                  </div>
                </div>
              </div>
              ...
              <div className="traffic-tracker px-8 py-3 shadow-lg flex justify-between align-center flex-row">
